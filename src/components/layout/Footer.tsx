    ...
    <footer className="bg-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">ShutterVista</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <a href="mailto:contact@shuttervista.com" className="text-gray-300 hover:text-teal transition-colors">contact@shuttervista.com</a>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} ShutterVista Photography. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
